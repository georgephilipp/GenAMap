...
//    private TaskMonitor taskMonitor = null;
    ...
    public AnnotationParser(BingoParameters params, HashSet<String> genes)
    {
        ...
        this.fullGoPath = openResourceFile("goOntologies/GO_Full");
        this.processGoPath = openResourceFile("goOntologies/GO_Biological_Process");
        this.functionGoPath = openResourceFile("goOntologies/GO_Molecular_Function");
        this.componentGoPath = openResourceFile("goOntologies/GO_Cellular_Component");
...
//            taskMonitor.setException(e, "");
    ...
    public String setFullOntology()
    {
        ...
        if (params.getOntologyFile().endsWith(".obo"))
        {
            ...
            try
            {
                BiNGOOntologyOboReader readerOntology = new BiNGOOntologyOboReader(params.getOntologyFile(), BingoAlgorithm.NONE);
