 ...
 * @author rcurtis
 */
public class GoResultsViewer extends javax.swing.JFrame
{
    /**
     * There is
     ...
     */
    private static GoResultsViewer instance;
     ...
     * @return
     */
    public static GoResultsViewer getInstance()
    {
        if (instance == null)
        {
            instance = new GoResultsViewer(GoInformationTable.getInstance());
        }
        return instance;
    }
     ...
     */
    public void setVisible(boolean b, String title, ArrayList<GoItems> items, ArrayList<String> gocats,
            Map<String, Color> goCatColorMap, GoListener listener, int type)
    {
        GoInformationTable.getInstance().setup(items, gocats, goCatColorMap, listener, type);
        this.setTitle(title);
    ...
    private GoResultsViewer(GoInformationTable table)
    {
        initComponents();
