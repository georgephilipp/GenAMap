 ...
 * @author RCurtis
 */
public class FeatInformationTable extends javax.swing.JPanel implements ListSelectionListener
{
    /**
     ...
     */
    private static FeatInformationTable instance;
    /**
     ...
     * @return
     */
    public static FeatInformationTable getInstance()
    {
        if (instance == null)
        {
            instance = new FeatInformationTable();
        }
        return instance;
    }

    /** Creates new form GoInformationTable */
    private FeatInformationTable()
    {
        initComponents();
     ...
     */
    public void setup(ArrayList<Marker> items, GoListener listener, int type)
    {
        try
        {
            this.listener = listener;
            jTable1.setModel(new FeatTableModel(items));
