 ...
 * @author Darryl
 */
public class VerticleLabelUI extends BasicLabelUI {
   ...
   protected static VerticleLabelUI verticalLabelUI =
         new VerticleLabelUI();
   private final static VerticleLabelUI SAFE_VERTICAL_LABEL_UI =
         new VerticleLabelUI();
    ...
    */
   public VerticleLabelUI(boolean clockwise) {
