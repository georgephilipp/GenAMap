...
public abstract class ValueAxis extends Axis
    ...
    public void setVerticalTickLabels(boolean flag) {
    	System.out.println("Setting Vertical tick label");
        ...
        while (iterator.hasNext()) {
            ...
            if (isTickLabelsVisible()) {
              ...
              //  }
               // else
               // {
                //	 TextUtilities.drawRotatedString("dd", g2,
                  //           anchorPoint[0], anchorPoint[1], tick.getTextAnchor(),
                   //          tick.getAngle(), tick.getRotationAnchor());
               // }
                //System.out.println("Tick in jfree: x: "+anchorPoint[0]+" y: "+anchorPoint[1]);
            }
